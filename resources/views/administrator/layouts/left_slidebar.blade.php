...
<nav class="navigation">
    <ul class="list-unstyled">
        ...
        <li class="has-submenu {{ Request::is('admin/users') || Request::is('admin/users-create') || Request::is('admin/edit-user/*') ? "active" : '' }}"><a href="#"><i class="fa fa-user"></i> <span class="nav-label">User Management</span></a>
            <ul class="list-unstyled">
        ...
        <li class="has-submenu {{Request::is('admin/helps') || Request::is('admin/help/create') || Request::is('admin/edit/help/*')|| Request::is('admin/help') || Request::is('admin/help-create')  ? "active" : '' }}"><a href="#"><i class="fa fa-info"></i> <span class="nav-label">Help</span></a>
            <ul class="list-unstyled">
                <li class="has-submenu {{ Request::is('admin/help/create') || Request::is('admin/edit/help/*') ? "active" : '' }}"><a href="{{route('help-create')}}">Add New</a></li>
                <li class="has-submenu {{ Request::is('admin/helps') ? "active":''}}"><a href="{{route('helps')}}">Manage Help</a></li>
            </ul>
        </li>
        <li class="has-submenu {{ Request::is('admin/vendor-list') ? "active":''}}"><a href="{{route('vendor-list')}}">
            <i class="bf-icon  fa fa-shopping-bag"></i>Vendors</a>
        </li>
        @endif
    </ul>
</nav>
