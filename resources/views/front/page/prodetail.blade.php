    ...
    <div class="img-product-wrapper">
      ...
      <div class="lg-img-view">
        <div class="inner">
            ...
            @else
                <img src="{!!$prodetail?$prodetail->image==''?asset('front/image/no1.png'):asset('uploads/product/feature/'.$prodetail->image):asset('front/image/no1.png') !!}" alt="" title="{!!$prodetail->name_en!!}" class="large-view">
            @endif
        </div>
      </div>
                    ...
                    <div class="content-product-right col-md-7 col-sm-12 col-xs-12">
                        ...
                        <div id="product">
                            <div class="form-group box-info-product">
                                <div class="cart">
                                    <input type="button" data-toggle="tooltip" title="" value="{!!trans('content.addtocart')!!}" data-loading-text="Loading..." id="button-cart" class="btn btn-mega btn-lg" onclick="cart.add('42', '1');" data-original-title="Add to Cart">
                                </div>
            ...
            <div class="producttab ">
                <div class="tabsslider horizontal-tabs  col-xs-12">
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#tab-1">{!!trans('content.description')!!}</a></li>
                    </ul>
             ...
             <div class="col-md-12 col-sm-12">
                <form class="form-horizontal" method="post" action="{{route('comment')}}" enctype="multipart/form-data">
                    ...
                    <input type="hidden" value="{!!$prodetail->id!!}" name="pro_id">
                        <label>{!!trans('content.comment')!!}: <span class="required">*</span></label>
                        <textarea cols="6" name="comment" rows="6" placeholder="{!!trans('content.yourcomment')!!}..." class="form-control"></textarea>
                    </div>
                    <button type="submit" class="btn btn-success pull-right">{!!trans('content.comment')!!}</button>
                </form>
            </div>
            <div class="related titleLine products-list grid module ">
                <h3 class="modtitle">{!!trans('content.relatedproducts')!!}  </h3>
                                            ...
                                            <form  method="post" class="formcart">
                                                ...
                                                <button type="button" class="addToCart btn-button" title="Add to cart" data-id="{!! $re->id !!}"
                                                  ...
                                                  data-img="{!!$re->image !!}">  
                                                    ...
                                                    <span>{!!trans('content.addtocart')!!} </span>
                                                </button>
                                            </form>
