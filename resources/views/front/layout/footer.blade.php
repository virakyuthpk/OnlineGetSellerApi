                        ...
                        <div class="modcontent">
                            <ul class="menu">
                               <!-- <li><img src="{!!asset('front/image/logo1.png') !!}" title="Your Store" alt="Your Store" /></li>-->
                                <li class="appstore"><a href="https://itunes.apple.com/kh/app/onlineget/id1415569080?mt=8" target="_blank"><img class="divle" src="{!!asset('front/image/applestore.png') !!}" alt="IOS"></a></li>
                                <li class="playstore"><a href="https://play.google.com/store/apps/details?id=phsatech.onlineget.starter" target="_blank"><img class="divle" src="{!!asset('front/image/googleplay.png') !!}" alt="Android"></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
