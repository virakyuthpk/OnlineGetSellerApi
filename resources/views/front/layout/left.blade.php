        ...
        @foreach($shops as $shop)
            <div class="module">
                <div class="banners banners2">
                    <a class="card-official-stores-box hp-mod-card-hover align-left" href="#" title="{!!$shop->shop_name!!}">
                    <div class="card-official-stores-brand-overlay"></div>
                    <div class="card-official-stores-brand-img">
                      <img src="{!! $shop?$shop->shop_cover==''?asset('front/image/defaul.jpg'):asset('uploads/vendor/'.$shop->shop_cover):asset('front/image/defaul.jpg') !!}" class="image" alt="Eloop">
                    </div>
                    <div class="card-official-stores-shop-img">
                      <img src="{!! $shop?$shop->pic==''?asset('front/image/default1.jpg'):asset('uploads/vendor/'.$shop->pic):asset('front/image/default1.jpg') !!}" class="image" alt="Eloop">
                    </div>
                    <div class="card-official-stores-h1">{!!$shop->shop_name!!}</div>
                   <!-- <p class="card-official-stores-p"> Power Bank </p>-->
                  </a>
                   <!-- <div class="banner">
                        <a href="#"><img src="{!! $shop?$shop->pic==''?asset('front/image/no1.png'):asset('uploads/vendor/'.$shop->pic):asset('front/image/no1.png') !!}" alt="image"></a>
                    </div>-->
                </div>
            </div>
        @endforeach
