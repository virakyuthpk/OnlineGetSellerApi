                    ...
                    <div id="sosearchpro" class="sosearchpro-wrapper so-search ">
                        <form method="GET" action="{{route('search')}}">
                            <div id="search0" class="search input-group form-group">
                                <input class="autosearch-input form-control" type="text" value="" size="50" autocomplete="off" placeholder=" {!!trans('menu.Search in Onlineget')!!}" name="search">
                                <span class="input-group-btn mobile">
                                    <button type="submit" class="button-search btn btn-primary" name="submit_search">{!!trans('menu.search')!!}</button>
                                </span>
                            </div>
                ...
                <div class="shopping_cart">
                    <div id="cart" class="btn-shopping-cart">
                        <a data-loading-text="Loading... " class="btn-group top_cart dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                            <div class="shopcart">
                                <span class="icon-c">
                                    <img src="{!!asset('front/image/cart.png') !!}" title="Cart" alt="Cart" />
