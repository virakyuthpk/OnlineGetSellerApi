...
@section('content')
@if(!$pcate->isEmpty())
    @foreach($pcate as $cate)
<div class="module listingtab-layout1">
    <h3 class="modtitle">
        <a target="_black" href="{{route('product-category',$cate->id)}}">
            <span>
                @if(App::isLocale('kh'))
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container second_img">
                                                <a href="{{route('product-detail',$pro->id)}}" target="_self" title="{!!$pro?$pro->name_en: ''!!}">
                                                    ...
                                                    <img src="{!! $pro->imgcover?$pro->imgcover->path==''?asset('front/image/no1.png'):asset('uploads/product/small/'.$pro->imgcover->path):asset('front/image/no1.png') !!}" class="img-2 img-responsive" alt="image">
                                                </a>
                                            </div>
                                            <div class="box-label">
                                                @if($pro->dis != null)
