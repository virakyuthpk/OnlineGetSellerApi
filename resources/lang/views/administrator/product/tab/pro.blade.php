...
<form class="form-horizontal" id="frm-properties" method="post" action="{{route('post-property',$id)}}" enctype="multipart/form-data">
	...
	<div class="form-group col-md-6">
		...
		<div class="col-md-9">
			<input type="text" name="product_name" value="{!!$product?$product->name_en : ''!!}" class="form-control">
		</div>
	</div>
	<div class="form-group col-md-6">
	...
	<div class="form-group col-md-6">
		...
		<input type="hidden" name="p_id[]"  value="{!!$product?$product->id: ''!!}">
			<select class="form-control" id="varian" name="variant[]" multiple="multiple">
  @if(!$variant->isEmpty())
				@foreach($variant as $var)
				<option value="{{$var->id}}" {{$product?$var->id==$product->supplier_id?'selected':'':''}}>{{$var->name_en}}</option>
				@endforeach
				@endif
</select>
		</div>
	...
	<div class="form-group col-md-12">
		...
		<div class="col-lg-10">
			<textarea class="form-control ckeditor" name="detail_en">{!!$product?$product->detail_en: ''!!}
			</textarea>
		</div>
	</div>
	<div class="form-group col-md-6">
		...
		<div class="col-lg-10">
			<textarea class="form-control ckeditor" name="review_en">{!!$product?$product->review_en: ''!!}
			</textarea>
		</div>
	</div>
	<div class="form-group col-md-6">
		...
		<div class="col-lg-10">
			<textarea class="form-control ckeditor" name="des">{!!$product?$product->des_en: ''!!}
			</textarea>
		</div>
	</div>
